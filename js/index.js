...
function calcularNota3() {
    ...
    if (cursos.hasOwnProperty(cursoSelecionado)) {
        ...
        mostrarDetalhes(nota1, nota2, notaRedacao, parseFloat(nota3Input.value), notaMinima, mediaFinal);
    } else {
...
function mostrarDetalhes(nota1, nota2, notaRedacao, nota3, notaCorte, mediaFinal) {
